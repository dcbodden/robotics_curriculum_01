...
This experiment follows the official Bluepad32 ESP-IDF + Arduino template, but
...
this experiment. Click is also pinned because the esptool version carried by the
...
- The template project, Bluepad32, and this experiment's derived bootstrap
