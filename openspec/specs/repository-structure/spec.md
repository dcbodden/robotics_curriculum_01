...
The repository SHALL provide top-level directories for electronics reference materials, numbered electronics fundamentals lessons, standalone experiments, syllabus and teacher materials, a PlatformIO Arduino Uno template, Arduino Uno lesson projects, and an ESP32 robotics PlatformIO template.

#### Scenario: Browse the repository root
- **WHEN** a contributor lists the repository root
- **THEN** they find `electronics-reference/`, `electronics-fundamentals-lessons/`, `experiments/`, `syllabus-and-teacher-materials/`, `platformio-uno-template/`, `platformio-uno-lessons/`, and `platformio-esp32-robotics-template/`
