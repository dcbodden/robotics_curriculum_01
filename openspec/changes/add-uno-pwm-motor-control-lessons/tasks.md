...
- [x] 5.3 Implement a consistent foreground snapshot of the shared ADC and PWM values, report it over serial, and block for 500 milliseconds between reports.
